...
///////////////////////////////////////////////////////////////////////////////////////////////////
//
// The source code after this point in the file is generic CUDA using the CUDA
// Runtime API and simple CUDA kernels to initialize matrices and compute the
...
cudaError_t ReferenceGemm(int M, int N, int K, float alpha, float const *A,
  ...
  ReferenceGemm_kernel<<<grid, block>>>(M, N, K, alpha, A, lda, B, ldb, beta, C,
                                        ldc);
